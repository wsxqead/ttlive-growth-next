    ...
    <div className="panel space-y-3 md:space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch w-full">
        ...
        <div className="flex flex-col items-center justify-center">
          <div
            className="relative rounded-2xl overflow-hidden group w-full flex-1"
            style={{
              maxWidth: requiredSize,
              aspectRatio: "1 / 1",
              boxShadow:
        ...
        <div className="flex flex-col gap-3 h-full">
          {/* 평판 지수 */}
          <div
            className="rounded-2xl border p-4 md:p-5 flex items-center justify-between flex-1"
            style={{
              borderColor: "#e6d38a",
              background: "#fffdf6",
          ...
          {/* 열혈팬 수 (월간 랭킹 스타일로 통일) */}
          <div
            className="rounded-2xl border p-4 flex flex-col items-center justify-center text-center flex-1"
            style={{
              borderColor: "#e6d38a",
              background: "linear-gradient(135deg, #fff8d6 0%, #fffef9 100%)",
              boxShadow: "0 2px 8px rgba(255,223,128,0.08)",
            }}
          >
            <div className="text-sm text-muted mb-1">열혈 팬 수</div>
            <div
              style={{
                fontSize: 26,
                fontWeight: 800,
                color: "#b8860b",
                textShadow: "0 2px 6px rgba(255,221,77,0.25)",
              }}
            >
              {fanCount.toLocaleString()} 명
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 h-full">
          <div
            className="rounded-2xl border p-5 flex flex-col items-center justify-center text-center flex-1"
            style={{
              borderColor: "#e6d38a",
          ...
          >
            <div className="text-sm text-muted mb-1">월간 랭킹</div>
            <div
              style={{
                fontSize: 26,
                fontWeight: 800,
